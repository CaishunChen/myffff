...
ICE_GRID_API void incRef(::IceGrid::FileParser*);
ICE_GRID_API void decRef(::IceGrid::FileParser*);

ICE_GRID_API void incRef(::IceProxy::IceGrid::FileParser*);
ICE_GRID_API void decRef(::IceProxy::IceGrid::FileParser*);
...
ICE_GRID_API void __write(::IceInternal::BasicStream*, const FileParserPrx&);
ICE_GRID_API void __read(::IceInternal::BasicStream*, FileParserPrx&);
ICE_GRID_API void __write(::IceInternal::BasicStream*, const FileParserPtr&);
ICE_GRID_API void __patch__FileParserPtr(void*, ::Ice::ObjectPtr&);

ICE_GRID_API void __addObject(const FileParserPtr&, ::IceInternal::GCCountMap&);
ICE_GRID_API bool __usesClasses(const FileParserPtr&);
ICE_GRID_API void __decRefUnsafe(const FileParserPtr&);
ICE_GRID_API void __clearHandleUnsafe(FileParserPtr&);
...
void ICE_GRID_API __patch__FileParserPtr(void*, ::Ice::ObjectPtr&);
