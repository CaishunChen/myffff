...
LOCAL_SRC_FILES := $(ICE_UTIL_SRCS) 

LOCAL_MODULE := IceUtil

GLOBAL_CFLAGS  :=  -D_REENTRANT -DNDEBUG  -ICE_UTIL_API_EXPORTS\
...
LOCAL_SHARED_LIBRARIES := gnustl_shared  bz2 ssl expat 		
