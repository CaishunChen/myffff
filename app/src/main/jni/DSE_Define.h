...
/**中间上的历史数据每组波形点数以及默认向客户端发送的波形数据个数
  */
#define GD_MIDDLEWARE_WAVE_POINT    16384
#define GD_MIDDLEWARE_WAVE_POINT_RC 16384
#define GD_MIDDLEWARE_WAVE_POINT_WIND 16384
#define GD_MIDDLEWARE_WAVE_POINT_MAX 81920 
...
enum GE_DATA_SOURCE_EN
{
	...
	GE_DATA_SOURCE_WIRELESS = 2, // 无线传感器采集测点
};
